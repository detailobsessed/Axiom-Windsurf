---
name: axiom-coreml
description: Deploy custom machine learning models on Apple devices with CoreML. Covers model conversion, compression, stateful models for LLMs, and performance optimization.
---
...
- `CoreML API Reference` (see upstream Axiom docs) — detailed API docs when you need exact method signatures or parameter options
- `CoreML Diagnostics` (see upstream Axiom docs) — troubleshooting when models fail to load, predictions are wrong, or performance is poor
- `Foundation Models` skill — use instead when you need Apple's built-in LLM rather than custom models
