...
**For advanced patterns:** See `sqlitedata-ref` skill for CTEs, views, custom aggregates, schema composition, and TableAlias.

**For raw GRDB:** See `grdb` skill when you need maximum SQL control.

## Related

- `sqlitedata-ref` skill — Advanced patterns: CTEs, views, aggregates, @Selection
- `grdb` skill — Raw GRDB for complex queries
