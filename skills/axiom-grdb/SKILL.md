...
**For SQLiteData:** See `sqlitedata` skill for type-safe @Table models with less boilerplate.

**For migrations:** See `database-migration` skill for safe schema evolution patterns.

## Related

- `sqlitedata` skill — Type-safe SQLiteData with @Table models
- `database-migration` skill — Safe migration patterns
- `swift-concurrency` skill — Async patterns for database actors
