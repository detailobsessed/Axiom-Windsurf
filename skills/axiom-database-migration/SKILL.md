...
**For persistence frameworks:** See `swiftdata` skill, `grdb` skill, or `sqlitedata` skill for framework-specific guidance.

## Related

- `swiftdata` skill — SwiftData patterns including schema versioning
- `grdb` skill — GRDB DatabaseMigrator patterns
- `sqlitedata` skill — SQLiteData @Column and migration patterns
- `xcode-debugging` skill — Environment diagnostics when migrations fail
