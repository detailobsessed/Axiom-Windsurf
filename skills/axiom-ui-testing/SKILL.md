...
**For Swift Testing framework:** See `swift-testing` skill for the new Swift Testing framework patterns.

## Related

- `swift-testing` skill — Swift Testing framework patterns
- `swift-concurrency` skill — @MainActor patterns for crash debugging
- `xcode-debugging` skill — Environment diagnostics when tests fail due to Xcode issues
