...
**For feature architecture:** See `swiftui-architecture` skill for MVVM, TCA, and property wrapper patterns.

**For navigation:** See `swiftui-nav` skill for NavigationStack patterns.

## Related

- `swiftui-architecture` skill — Feature-level patterns (MVVM, TCA)
- `swiftui-nav` skill — Navigation patterns
- `swift-concurrency` skill — Async patterns for state management
