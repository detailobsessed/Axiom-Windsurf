---
name: axiom-speech
description: "Implement speech-to-text with Apple's new SpeechAnalyzer API (iOS 26+). Powers Notes, Voice Memos, Journal, and Call Summarization."
---
...
- `CoreML` skill — deploy custom speech/audio ML models when SpeechAnalyzer doesn't meet your needs
- `Foundation Models` skill — generate summaries or titles from transcribed text using Apple Intelligence
