...
**For navigation:** See `swiftui-nav` skill for NavigationStack and deep linking patterns.

**For app-level composition:** See `app-composition` skill for @main, root switching, and scene lifecycle.

## Related

- `swiftui-nav` skill — Navigation patterns (NavigationStack, deep linking)
- `app-composition` skill — App-level patterns (@main, root switching)
- `swift-concurrency` skill — Async patterns for models
