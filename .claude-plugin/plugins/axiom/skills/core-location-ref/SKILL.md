...
- `core-location` — Anti-patterns, decision trees, pressure scenarios
- `core-location-diag` — Symptom-based troubleshooting
- `energy-ref` — Location as battery subsystem (accuracy vs power)
...
**Skills**: core-location, core-location-diag, energy-ref
