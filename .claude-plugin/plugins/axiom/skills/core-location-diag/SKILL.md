...
- `core-location` — Implementation patterns, decision trees
- `core-location-ref` — API reference, code examples
- `energy-diag` — Battery drain from location
...
**Skills**: core-location, core-location-ref, energy-diag
