...
1. **Always run all 5 pattern searches** - Don't skip categories
2. **Provide file:line references** - Make issues easy to locate
3. **Show exact fixes** - Include code examples for each issue
4. **Categorize by severity** - Help prioritize fixes
5. **Calculate risk score** - Quantify overall safety level
