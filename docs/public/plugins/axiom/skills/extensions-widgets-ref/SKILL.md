...
- Widgets refresh 40-70 times per day maximum
- Use Live Activities for events lasting hours, not seconds
- For truly real-time data, keep users in the app

❌ **Complex interactions or multi-step workflows**
- Widgets support simple buttons/toggles only
- No text input, no navigation, no gestures beyond tap
- Deep link to app for complex flows

❌ **Large amounts of data or long lists**
- Limited screen space (smallest: ~170×170pt)
- No scrolling in widgets
- Show summary, not exhaustive lists

❌ **Personalized data requiring authentication**
- Widget views are not protected by FaceID/TouchID
- Don't show sensitive financial/health data
- Consider what's appropriate for Lock Screen

❌ **Heavy computation or network requests**
- Extensions have strict memory limits (~30MB)
- Timeline generation should complete in seconds
- Precompute and cache in main app
...
4. Uncheck "Include Configuration Intent" (we'll add this later if needed)
...
2. Click + and create: `group.com.yourcompany.yourapp`

**In widget extension target**:
1. Signing & Capabilities → + Capability → App Groups
2. Select the SAME group identifier
...
### Step 5: Implement TimelineProvider
...
### Step 8: Update Data from Main App
...
1. **Run widget extension** (not main app) from Xcode
2. Choose widget size in debug menu
3. **Add to Home Screen**: Long press → + → Find your widget
4. **Verify data**: Check widget shows data from app
5. **Test refresh**: Change data in app, verify widget updates
...
- [ ] Tested all supported families (small, medium, etc.)
- [ ] Verified timeline refresh policy reasonable (not < 15 min)
- [ ] Memory usage checked (should be < 30MB)
- [ ] Widget appears in widget gallery
- [ ] Data updates when app changes data
- [ ] Handles missing/nil data gracefully
- [ ] Tested on different iOS versions you support
...
- **278** — [What's new in widgets](https://developer.apple.com/videos/play/wwdc2025/278/)
  - Liquid Glass rendering, CarPlay widgets, visionOS support, Relevance configuration

### iOS 18 (WWDC 2024)
- **10157** — [Extend your app's controls across the system](https://developer.apple.com/videos/play/wwdc2024/10157/)
  - ControlWidget, Button, Toggle, Value Providers
- **10068** — [Bring your Live Activity to Apple Watch](https://developer.apple.com/videos/play/wwdc2024/10068/)
  - supplementalActivityFamilies, activityFamily environment
- **10098** — [Design Live Activities for Apple Watch](https://developer.apple.com/videos/play/wwdc2024/10098/)
  - Smart Stack design, glanceability, compact view

### iOS 17 (WWDC 2023)
- **10028** — [Bring widgets to life](https://developer.apple.com/videos/play/wwdc2023/10028/)
  - Interactive widgets, App Intents, animations
- **10194** — [Design dynamic Live Activities](https://developer.apple.com/videos/play/wwdc2023/10194/)
  - Lock Screen, StandBy, Dynamic Island, design principles

### iOS 16 (WWDC 2022)
- **10184** — [Meet ActivityKit](https://developer.apple.com/videos/play/wwdc2022/10184/)
  - Live Activities basics, ActivityAttributes, starting/ending
- **10185** — [Update Live Activities with push notifications](https://developer.apple.com/videos/play/wwdc2022/10185/)

## Apple Documentation

- [WidgetKit](https://sosumi.ai/documentation/widgetkit) — Widget framework
- [ActivityKit](https://sosumi.ai/documentation/activitykit) — Live Activities
- [App Intents](https://sosumi.ai/documentation/appintents) — Interactive widgets and configuration
- [App Groups](https://sosumi.ai/documentation/bundleresources/entitlements/com_apple_security_application-groups) — Data sharing entitlement
...
- [Creating Control Center controls](https://developer.apple.com/documentation/widgetkit/creating-control-center-controls)

## Human Interface Guidelines

- [Widgets](https://developer.apple.com/design/human-interface-guidelines/widgets) — Design guidance
- [Live Activities](https://developer.apple.com/design/human-interface-guidelines/live-activities) — Design principles
- [Dynamic Island](https://developer.apple.com/design/human-interface-guidelines/dynamic-island) — Presentation guidelines
