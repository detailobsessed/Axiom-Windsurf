...
minimum_versions: iOS 13+ (Dark Mode), iOS 17+ (latest semantic colors), iOS 26+ (Liquid Glass)
---
...
#### Related Skills
- Use `hig-ref` for comprehensive details and code examples
- Use `liquid-glass` for iOS 26 material design implementation
- Use `liquid-glass-ref` for iOS 26 app-wide adoption guide
